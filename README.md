...
티켓 오픈 순간 대규모 동시 접속 트래픽을 안정적으로 처리하기 위해 **Lambda + EKS 하이브리드 아키텍처**, **VWR 2-Tier 대기열**, **5계층 보안**, **EKS 외부 모니터링**을 결합한 운영 가능한 티켓팅 시스템.
...
| **부하 테스트** | k6 기반 단계별 (100 → 500 → 1,000 → 2,000명) 시나리오 설계·실행·튜닝 |
